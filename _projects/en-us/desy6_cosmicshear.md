...
{% include figure.liquid loading="eager" path="assets/img/y6_lensing_surveys_2d1d.pdf" title="example image" class="img-fluid rounded z-depth-1" %}
Figure1: Cosmological constraints (clustering amplitude: S_8 and total matter density: \Omega_m) from DES Y6 cosmic shear, in comparison to other lensing surveys.
